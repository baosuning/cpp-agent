...
The skill will be created at <path>/<skill-name>/.

For this project, skills are stored under agent_cli/config/skills/.
Example:
    python scripts/init_skill.py my-new-skill --path agent_cli/config/skills
"""
...
def main():
    if len(sys.argv) < 4 or sys.argv[2] != '--path':
        ...
        print("\nFor this project, skills are stored under agent_cli/config/skills/.")
        print("\nExamples:")
        print("  init_skill.py my-new-skill --path agent_cli/config/skills")
        sys.exit(1)
